    ...
    public void startStop() throws IOException {
        if(run)
            ...
            if(i%4==0)
            {
                ...
                if (ques_vv != null)
                {  ques_vv.setVideoURI(Uri.parse(img.get(i)));
            ...
            else
            {
                ...
                Uri myUri = Uri.parse("http://www.all-birds.com/Sound/western%20bluebird.wav");
                for(int j=0;j<10;j++)
                {
